...
public class DrawFrame extends JFrame implements ActionListener, MouseListener{
	...
	public DrawFrame() {
		...
		initDrawPanel() ;
		setSize(500,400) ; //Establecemos el tamaÃ±o de la ventana, si no va despues de initToolBar() la ventana modificarÃ¡ su tamaÃ±o	
	}
	...
	private void initDrawPanel() {
		...
		add(drawPanel, BorderLayout.CENTER) ; //AÃ±adimos el JPanel a la ventana situandolo en el centro
	...
	public void actionPerformed(ActionEvent e) {
		...
		newShape = new NewRectangle();
		shapeList.addShape(newShape); //AÃ±adimos el rectangulo a la lista para dibujar varios
